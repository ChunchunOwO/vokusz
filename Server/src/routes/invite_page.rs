...
/// - For browsers: attempts a `vokusz://` protocol redirect, with a fallback
...
pub async fn invite_page(
    ...
    // Strip port from host for the vokusz:// URI if it's the default
...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Join {space_name} on Vokusz</title>
