...
Profiles let you maintain separate configurations -- each with its own servers, settings, and preferences. This is useful if you use vokusz for different purposes (e.g., work and personal).
...
You can add a PIN to make Vokusz show an unlock screen before opening a profile. This is only a casual UI lock for situations such as handing an already-unlocked device to someone briefly.
