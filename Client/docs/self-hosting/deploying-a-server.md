...
vokusz connects to servers running [accordserver](https://github.com/ChunchunOwO/vokusz). You can host your own server to keep full control of your community's data.
...
1. Clone the repository:
   ...
   ```bash
   git clone https://github.com/ChunchunOwO/vokusz.git
   cd accordserver
   ```
...
Register your server with the vokusz master server so users can discover it in the public server list.
