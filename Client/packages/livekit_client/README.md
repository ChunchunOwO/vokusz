...
Vokusz's voice stack under [`lib/features/voice/`](../../lib/features/voice/);
...
export VOKUSZ_WEB_APP_DIR=/path/to/your/flutter_app
dart compile js web/e2ee.worker.dart \
  -o "$VOKUSZ_WEB_APP_DIR/web/e2ee.worker.dart.js" -m
```
