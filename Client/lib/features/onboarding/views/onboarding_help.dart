...
const String kVokuszIssuesUrl = 'https://github.com/$kGithubRepo/issues';

/// The wider project (server, protocol docs, the reference client).
const String kVokuszUrl = 'https://github.com/ChunchunOwO';
...
const List<OnboardingHelpLink> kOnboardingHelpLinks = <OnboardingHelpLink>[
  ...
  OnboardingHelpLink(
    ...
    url: kVokuszIssuesUrl,
    icon: Icons.bug_report_outlined,
  ),
  OnboardingHelpLink(
    label: 'The Vokusz project',
