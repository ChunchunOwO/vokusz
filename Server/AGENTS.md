...
This is the Vokusz chat/voice server backend. It's a Rust web server built with Axum that provides a WebSocket gateway, REST endpoints, and LiveKit/WebRTC voice routing — including free screen sharing for the Vokusz Flutter client. Call quality is a product requirement, not an add-on.
