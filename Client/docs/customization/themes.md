...
description: Customize the look and feel of vokusz.
order: 1
...
vokusz comes with several built-in themes and supports full color customization.
...
3. The recipient can apply it by:
   ...
   - Pasting the theme string in chat -- vokusz detects it and shows an **Apply Theme** button inline
...
Animated images also pause automatically whenever vokusz is hidden,
