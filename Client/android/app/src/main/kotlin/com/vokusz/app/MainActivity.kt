...
/// Hosts the `com.vokusz.app/installer` method channel used by the in-app
...
/// first when needed.
///
/// Also hosts `com.vokusz.app/background_connection`, which starts/stops the
...
class MainActivity : FlutterActivity() {
    private val channelName = "com.vokusz.app/installer"
    private val backgroundChannelName = "com.vokusz.app/background_connection"
    ...
    private fun installApk(path: String) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O &&
            ...
            throw IllegalStateException(
                "Allow installing apps from Vokusz, then tap Update again.",
            )
        }
