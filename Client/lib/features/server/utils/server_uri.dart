...
/// A parsed "Add a Server" URL or `vokusz://` deep link.
///
...
/// Parsing for "Add a Server" URLs and `vokusz://` deep links.
class ServerUri {
  ...
  static ParsedServerUrl? parseServerUrl(String raw) {
    ...
    if (text.startsWith('vokusz://')) return parseDeepLink(text);
  ...
  ///   `vokusz://federate/<space-id>@<home-domain>`
  ...
  /// Parses `vokusz://federate/<space-id>@<home-domain>` — join a space homed
