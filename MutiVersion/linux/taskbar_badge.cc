...
// /usr/share/applications/vokusz.desktop); launchers key the badge off it and
...
static constexpr char kChannelName[] = "com.vokusz.app/taskbar_badge";
...
static constexpr char kAppUri[] = "application://vokusz.desktop";
