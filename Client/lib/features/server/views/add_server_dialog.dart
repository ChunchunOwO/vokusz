...
/// add-server flow: an **Enter URL** tab (paste a server URL or `vokusz://`
...
/// `vokusz://` deep link is opened while already signed in. [joinSpaceId], when
          ...
          if (_step == _UrlStep.url) ...[
            ...
            TextField(
              ...
              decoration: const InputDecoration(
                isDense: true,
                hintText: 'chat.example.com  or  vokusz://connect/...',
