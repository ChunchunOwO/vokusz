# Vokusz Server — desktop tray app
...
- **Quit Vokusz Server** — gracefully stops both sidecars
...
| Linux | `$XDG_DATA_HOME/vokusz/` (default: `~/.local/share/vokusz/`) |
...
```
https://github.com/ChunchunOwO/vokusz/releases/latest/download/latest.json
```
