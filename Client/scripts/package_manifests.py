...
REPOSITORY = 'https://github.com/ChunchunOwO/vokusz'
ASSETS = {
    'WINDOWS_INSTALLER': 'vokusz-windows-x86_64-setup.exe',
    'WINDOWS_PORTABLE': 'vokusz-windows-x86_64.zip',
    'LINUX': 'vokusz-linux-x86_64.tgz',
}
MACOS_ASSETS = ('vokusz-macos-universal.dmg', 'vokusz-macos-universal-package-manager.dmg')
...
def rendered_files(values, templates=TEMPLATES):
    ...
    files['flatpak/vokusz.png'] = (ROOT / 'dist/icons/icon_256x256.png').read_bytes()
