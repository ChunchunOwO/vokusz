...
const String appTermsSummary =
    'Vokusz has a zero-tolerance policy for objectionable content and '
    'abusive behaviour.';
...
const String appTermsContactUrl =
    'https://github.com/ChunchunOwO/vokusz/issues';
...
By using Vokusz you agree to these Terms of Use and Community Guidelines. If
you do not agree, do not use the app.

2. What Vokusz is

Vokusz is a client application. It connects to Accord servers (also called
...
abusively. You must not use Vokusz to post, send, or share:
...
Vokusz does not collect analytics, does not show ads, and does not track you.
...
Vokusz is free and open-source software, licensed under the GNU General Public
