...
End-user documentation for the Vokusz chat client. This content is designed to be pulled by external services (static site generators, help portals, etc.) to produce website documentation.
