...
/// `com.vokusz.app/background_connection` channel (see MainActivity).
    ...
    private fun startInForeground() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            val channel = NotificationChannel(
                ...
                description =
                    "Keeps Vokusz connected while the app is in the background."
                setShowBadge(false)
            }
        ...
        val notification = NotificationCompat.Builder(this, CHANNEL_ID)
            .setContentTitle("Vokusz is connected")
